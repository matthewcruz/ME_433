package com.mattcruz10gmail.androidcam;
...
public class MainActivity extends Activity implements TextureView.SurfaceTextureListener {
    ...
    static int RedThresh = 50*255/100;
    static int GreenThresh = 50*255/100;
    static int BlueThresh = 50*255/100;
    ...
    private void setMyControlListener() {
        RedControl.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                RedThresh = progress*255/100;
                myTextViewRed.setText("Red Threshold: "+progress);
            }
        ...
        GreenControl.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                progressChanged = progress;
                GreenThresh = progress*255/100;
                myTextViewGreen.setText("Green Threshold: "+progress);
            }
        ...
        BlueControl.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                progressChanged = progress;
                BlueThresh = progress*255/100;
                myTextViewBlue.setText("Blue Threshold: "+progress);
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myTextViewRed.setTextColor(Color.RED);
        myTextViewGreen = (TextView) findViewById(R.id.textViewGreen);
        myTextViewGreen.setTextColor(Color.GREEN);
        myTextViewBlue = (TextView) findViewById(R.id.textViewBlue);
        myTextViewBlue.setTextColor(Color.BLUE);
    ...
    public void onSurfaceTextureUpdated(SurfaceTexture surface) {
        ...
        if (c != null) {
            ...
            //myTextViewBlue.setText(""+BlueThresh);
...
//                }
                if ( (red(pixels[i]) > RedThresh) && (green(pixels[i]) < GreenThresh) ){
                //myTextViewBlue.setText(""+RedThresh);
                //if (red(pixels[i]) > RedThresh){
                    thresholdedPixels[i] = 255*3;
//                    if ( (red(pixels[i]) >160) && (green(pixels[i]) > 160) && (blue(pixels[i]) > 160) ){
//                        thresholdedPixels[i] = 0;
//                    }
                }
                else{
            ...
            canvas.drawCircle(COM, startY, 10, paint1);
