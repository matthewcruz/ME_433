...
//
//                }
                //we are expecting an integer between 0 and 100 where 50 is middle

                OC1RS = 2999 + (qq-50)*38;
                OC2RS =  2999 - (qq-50)*38;//- ((qq - 50)*(pwm_scale/50));
//                int mid = 2999;
//                
//                if (qq>50){
//                    OC1RS = mid;
//                    OC2RS =  mid - (qq-50)*34;//- ((qq - 50)*(pwm_scale/50));
//                }
//                
//                else{
//                    OC1RS = mid - (50-qq)*34;
//                    OC2RS =  mid;//- ((qq - 50)*(pwm_scale/50));
//                }
//////                              
